...
export const BOARD_CONFIG: Record<string, BoardConfigEntry> = {
  ...
  'sudoku:sudoku_antiknight_easy':   { sort: 'asc',  min: 10,  max: 7200   },
  'sudoku:sudoku_antiknight_medium': { sort: 'asc',  min: 15,  max: 7200   },
  'sudoku:sudoku_antiknight_hard':   { sort: 'asc',  min: 30,  max: 7200   },
  'sudoku:sudoku_antiknight_expert': { sort: 'asc',  min: 60,  max: 7200   },
  'sudoku:sudoku_antiking_easy':     { sort: 'asc',  min: 10,  max: 7200   },
  'sudoku:sudoku_antiking_medium':   { sort: 'asc',  min: 15,  max: 7200   },
  'sudoku:sudoku_antiking_hard':     { sort: 'asc',  min: 30,  max: 7200   },
  'sudoku:sudoku_antiking_expert':   { sort: 'asc',  min: 60,  max: 7200   },
