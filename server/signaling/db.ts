...
export const BOARD_CONFIG: Record<string, BoardConfigEntry> = {
  ...
  'sudoku:antiknight_expert':     { sort: 'asc',  min: 60,  max: 7200   },
  'sudoku:antiking_easy':         { sort: 'asc',  min: 10,  max: 7200   },
  'sudoku:antiking_medium':       { sort: 'asc',  min: 15,  max: 7200   },
  'sudoku:antiking_hard':         { sort: 'asc',  min: 30,  max: 7200   },
  'sudoku:antiking_expert':       { sort: 'asc',  min: 60,  max: 7200   },
  'sudoku:killer_easy':           { sort: 'asc',  min: 30,  max: 7200   },
  'sudoku:killer_medium':         { sort: 'asc',  min: 60,  max: 7200   },
  'sudoku:killer_hard':           { sort: 'asc',  min: 90,  max: 7200   },
  'sudoku:killer_expert':         { sort: 'asc',  min: 120, max: 7200   },
  'sudoku:mini':                  { sort: 'asc',  min: 5,   max: 3600   },
  ...
  'shikaku:shapes_5':     { sort: 'asc',  min: 3,   max: 3600   },
  'shikaku:shapes_7':     { sort: 'asc',  min: 5,   max: 3600   },
  'shikaku:shapes_8':     { sort: 'asc',  min: 8,   max: 3600   },
  'shikaku:shapes_10':    { sort: 'asc',  min: 10,  max: 3600   },
  'shikaku:shapes_12':    { sort: 'asc',  min: 15,  max: 3600   },
  'shikaku:shapes_15':    { sort: 'asc',  min: 20,  max: 3600   },
  'crown_grid:easy':      { sort: 'asc',  min: 3,   max: 3600   },
  'crown_grid:medium':    { sort: 'asc',  min: 5,   max: 3600   },
  'crown_grid:hard':      { sort: 'asc',  min: 8,   max: 3600   },
  'crown_grid:expert':    { sort: 'asc',  min: 12,  max: 3600   },
  'eclipse_grid:4':       { sort: 'asc',  min: 2,   max: 3600   },
  'eclipse_grid:6':       { sort: 'asc',  min: 4,   max: 3600   },
  'eclipse_grid:8':       { sort: 'asc',  min: 8,   max: 3600   },
  'eclipse_grid:10':      { sort: 'asc',  min: 12,  max: 3600   },
  'number_path:easy':     { sort: 'asc',  min: 2,   max: 3600   },
  'number_path:medium':   { sort: 'asc',  min: 4,   max: 3600   },
  'number_path:hard':     { sort: 'asc',  min: 6,   max: 3600   },
  'number_path:expert':   { sort: 'asc',  min: 8,   max: 3600   },
